...
export default defineConfig(
  ...
  {
    // Generated by tauri-specta (AGENTS.md section 5: never edited by
    // hand), so its runtime helpers are out of our style control — for
    // example the `catch` branch of its typed-error wrapper is untyped by
    // design. Architecture-boundary rules above still apply in full.
    files: ["apps/desktop/src/ipc/**/*.{ts,tsx}"],
    rules: {
